...
int main () {
    ...
    *(int *)0x80930080 |= 0x1; // Writes SHena bit of DeviceCfg Syscon register
    ...
    // Turn interrupts on
    // *(int *)(VIC1_IRQ_BASE + IRQ_ENABLE_OFFSET) = TC1UI_MASK | TC2UI_MASK | UART1_RX_INTR1_MASK | UART1_TX_INTR1_MASK | UART2_RX_INTR2_MASK | UART2_TX_INTR2_MASK;
    *(int *)(VIC1_IRQ_BASE + IRQ_ENABLE_OFFSET) = TC1UI_MASK | TC2UI_MASK | UART2_RX_INTR2_MASK | UART2_TX_INTR2_MASK;

    // *(int *)(VIC2_IRQ_BASE + IRQ_ENABLE_OFFSET) = TC3UI_MASK;
    *(int *)(VIC2_IRQ_BASE + IRQ_ENABLE_OFFSET) = TC3UI_MASK | INT_UART1_MASK;
